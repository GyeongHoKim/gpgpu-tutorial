...
> 주의: WebGPU는 **모든 브라우저에서 항상 켜져 있지 않습니다.** 최신 Chrome/Edge, WebGPU를 지원하는 Safari 등에서만 동작하고, 환경에 따라 `navigator.gpu` 가 `undefined` 일 수 있습니다. 그래서 모든 예제는 시작할 때 지원 여부를 먼저 확인합니다. 자세한 요구사항은 저장소 루트의 `README.md` "브라우저 요구사항" 절을 보세요.
